...
"""
    ...
    def generate_response(
        ...
        state = ConversationState(
            ...
            round_number=1,
            api_params_base={**self.base_params, "system": system_content},
        )
        ...
        if tools and tool_manager:
            ...
            api_params = {**state.api_params_base, "messages": state.messages}
    ...
    def _execute_conversation_loop(
        self, state: ConversationState, tools: List, tool_manager
    ) -> str:
        """
    ...
    def _execute_tools_and_update_state(
        self, state: ConversationState, response, tool_manager
    ):
        """
    ...
    def _get_final_response_without_tools(
        self, state: ConversationState, last_response
    ) -> str:
        """
        ...
        final_params = {**state.api_params_base, "messages": state.messages}
