...
class TestAIGenerator:
    ...
    def setup_method(self):
        ...
        self.ai_generator = AIGenerator(
            api_key="test-api-key", model="claude-3-sonnet-20241022"
        )
    ...
    def test_system_prompt_content(self):
        ...
        assert (
            ...
            or "Course Content Search" in system_prompt
        )
        assert (
            "get_course_outline" in system_prompt or "Course Outline" in system_prompt
        )
    ...
    def test_generate_response_with_tools_no_tool_use(self):
        ...
        response = self.ai_generator.generate_response("Hello", tools=mock_tools)
    ...
    def test_generate_response_with_tool_use(self):
        ...
        response = self.ai_generator.generate_response(
            "Search for AI content", tools=mock_tools, tool_manager=mock_tool_manager
        )
        ...
        assert (
            response
            == "Based on the search results, AI is the simulation of human intelligence in machines."
        )
    ...
    def test_handle_tool_execution(self):
        ...
        response = self.ai_generator._handle_tool_execution(
            MOCK_ANTHROPIC_RESPONSE_TOOL_USE, base_params, mock_tool_manager
        )
...
class TestSequentialToolCalling:
    ...
    def test_no_tools_first_response_termination(self):
        ...
        response = self.ai_generator.generate_response(
            "What is AI in general?", tools=mock_tools, tool_manager=mock_tool_manager
        )
    ...
    def test_tool_execution_error_handling(self):
        ...
        response = self.ai_generator.generate_response(
            "Search for something", tools=mock_tools, tool_manager=mock_tool_manager
        )
    ...
    def test_tools_available_in_all_rounds(self):
        ...
        self.ai_generator.generate_response(
            "Complex query", tools=mock_tools, tool_manager=mock_tool_manager
        )
    ...
    def test_multiple_tools_in_single_response(self):
        ...
        response = self.ai_generator.generate_response(
            "Tell me about AI courses", tools=mock_tools, tool_manager=mock_tool_manager
        )
