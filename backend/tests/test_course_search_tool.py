...
class TestCourseSearchTool:
    ...
    def test_execute_successful_search(self):
        ...
        assert self.search_tool.last_sources[0]["text"] == "Introduction to Artificial Intelligence - Lesson 1"
        assert self.search_tool.last_sources[1]["text"] == "Introduction to Artificial Intelligence - Lesson 2"
    ...
    def test_format_results_without_lesson_number(self):
        ...
        assert "Lesson" not in result.split("\n")[0]  # Check first line doesn't have "Lesson"
