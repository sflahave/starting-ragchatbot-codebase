...
from tests.fixtures.mock_data import MOCK_COURSE_1, MOCK_CHUNKS
...
class TestVectorStore:
    ...
    def test_search_with_partial_course_name(self):
        ...
        results = self.vector_store.search(
            "intelligence",
            course_name="Artificial Intelligence"  # Partial match
        )
    ...
    def test_search_nonexistent_course(self):
        ...
        results = self.vector_store.search(
            "intelligence",
            course_name="Underwater Basket Weaving Advanced Techniques"
        )
        ...
        if not results.error:
            ...
            for metadata in results.metadata:
                ...
                assert metadata["course_title"] in ["Introduction to Artificial Intelligence"]
        else:
    ...
    def test_resolve_course_name_exact_match(self):
        ...
        resolved = self.vector_store._resolve_course_name("Introduction to Artificial Intelligence")
    ...
    def test_resolve_course_name_no_match(self):
        ...
        resolved = self.vector_store._resolve_course_name("Underwater Basket Weaving Techniques")
    ...
    def test_get_course_link(self):
        ...
        link = self.vector_store.get_course_link("Introduction to Artificial Intelligence")
    ...
    def test_get_lesson_link(self):
        ...
        link = self.vector_store.get_lesson_link("Introduction to Artificial Intelligence", 1)
        assert link == "https://example.com/course1/lesson1"
        
        link = self.vector_store.get_lesson_link("Introduction to Artificial Intelligence", 2)
        assert link == "https://example.com/course1/lesson2"
        
        # Test nonexistent lesson
        link = self.vector_store.get_lesson_link("Introduction to Artificial Intelligence", 99)
        assert link is None
