...
MOCK_SEARCH_RESULTS_EMPTY = SearchResults(documents=[], metadata=[], distances=[])
...
MOCK_CHROMA_RESULTS_EMPTY = {"documents": [[]], "metadatas": [[]], "distances": [[]]}

# Mock Anthropic API Responses
MOCK_ANTHROPIC_RESPONSE_SIMPLE = type(
    "MockResponse",
    (),
    {
        "content": [
            type("Content", (), {"text": "This is a simple response without tools."})()
        ],
        "stop_reason": "end_turn",
    },
)()

MOCK_ANTHROPIC_RESPONSE_TOOL_USE = type(
    "MockResponse",
    (),
    {
        "content": [
...
MOCK_ANTHROPIC_RESPONSE_FINAL = type(
    "MockResponse",
    (),
    {
        "content": [
            type(
                ...
                (),
                {
                    "text": "Based on the search results, AI is the simulation of human intelligence in machines."
                },
            )()
        ],
        "stop_reason": "end_turn",
...
MOCK_SEQUENTIAL_ROUND_1_TOOL_USE = type(
    "MockResponse",
    (),
    {
        "content": [
...
MOCK_SEQUENTIAL_ROUND_2_TOOL_USE = type(
    "MockResponse",
    (),
    {
        "content": [
...
MOCK_SEQUENTIAL_FINAL_RESPONSE = type(
    "MockResponse",
    (),
    {
        "content": [
            type(
                ...
                (),
                {
                    "text": "Based on the course outline and search results, lesson 2 covers machine learning basics which is fundamental to AI."
                },
            )()
        ],
        "stop_reason": "end_turn",
...
MOCK_SEQUENTIAL_NO_TOOLS_RESPONSE = type(
    "MockResponse",
    (),
    {
        "content": [
            type(
                ...
                (),
                {
                    "text": "I can answer that directly without needing to search: AI is a broad field of computer science."
                },
            )()
        ],
        "stop_reason": "end_turn",
...
MOCK_MULTIPLE_TOOLS_RESPONSE = type(
    "MockResponse",
    (),
    {
        "content": [
