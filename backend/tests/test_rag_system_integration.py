...
from tests.fixtures.mock_data import MOCK_CONFIG, MOCK_ANTHROPIC_RESPONSE_SIMPLE
...
Advanced integration testing involves complex scenarios with multiple systems, APIs, and databases. Mocking and stubbing are essential techniques for isolating the system under test.""")
    ...
    def test_query_tool_execution_flow(self, mock_anthropic):
        ...
        mock_tool_response = type('MockResponse', (), {
            'content': [
                type('Content', (), {
                    'type': 'tool_use',
                    'name': 'search_course_content',
                    'id': 'tool_123',
                    'input': {'query': 'integration testing', 'course_name': None, 'lesson_number': None}
                })()
            ],
        ...
        mock_final_response = type('MockResponse', (), {
            'content': [type('Content', (), {'text': 'Integration testing is a crucial phase in software testing.'})()],
